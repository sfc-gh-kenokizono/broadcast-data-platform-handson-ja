...
V2配布データのローカル期待値は、リーチ20,000台・総視聴回数1,050,000回・総視聴時間約12,511,642.266667分です。V2のSnowflake上での2経路の照合は未検証です。
...
V2データでのSemantic View・直接SQLの照合、Agent作成と権限付与は未検証です。SQLの冒頭にある旧版の実行記録は、V2の成功を示すものではありません。
